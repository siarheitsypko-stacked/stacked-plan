using Stacked.Application.Common.Models;
using Stacked.Application.TodoItems.Commands.CreateTodoItem;
using Stacked.Application.TodoItems.Commands.DeleteTodoItem;
using Stacked.Application.TodoItems.Commands.UpdateTodoItem;
using Stacked.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Stacked.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace Stacked.Web.Endpoints;
